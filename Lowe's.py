                ...
                for i in graph[row]:
                    ...
                    if(i != 0):
                        ...
                        if(node==iteration and j!=iteration-2):
                            trueTableValue = True # I hope thest two lines give a good shot
                        if trueTableValue is False:
#                            labelNumber = labelNumber + 1 #I hope change this order to end works
                            memory=set1
                            length=len(memory)
...
#                                print(set1)
                                ...
                                # I hope it works now
                                # I need to print sets included the label number here for each iteration.
#            print("iteration is ", j+2)
...
if __name__ == '__main__':
    ...
    # I feel so glad the final result works now same with the paper.
    # But in the future, jingyiqiujing, something can be directed to deal with the destination
    # show up early issue.
